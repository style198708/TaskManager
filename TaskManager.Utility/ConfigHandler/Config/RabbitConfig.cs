...
namespace TaskManager.Utility.ConfigHandler
{
    /// <summary>
    /// MQ消息队列配置信息
    /// </summary>
    ...
    public class RabbitMQConfig : ConfigOption
    {
        ...
        /// 任务队列名称
        /// </summary>
        [Config(Name = "任务队列名称", DefaultValue = "TaskManager.Queue.Task")]
        public static string QueueName { get; set; }

        /// <summary>
        /// MQ主机IP
        /// </summary>
        [Config(Name = "主机地址", ValidateRule = "ipv4=true", DefaultValue = "192.168.0.102")]
        ...
        /// MQ连接密码
        /// </summary>
        [Config(Name = "密码", ValueType = ConfigValueType.Password, DefaultValue = "admin1234")]
